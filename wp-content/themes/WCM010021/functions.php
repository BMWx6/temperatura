...
function templatemela_setup() {
	...
	register_nav_menus( array(
    	 ...
    	 'header-menu'   => __( 'TM Header Shop Links', 'templatemela' ),
...
function templatemela_scripts_styles() {
	...
	wp_enqueue_script( 'templatemela-script', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '20150330', true );
