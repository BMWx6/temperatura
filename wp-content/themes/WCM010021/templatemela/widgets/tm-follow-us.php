...
<div id="follow_us" class="follow-us">	
	...
	<?php if(!empty($linkURL7)) :  ?>
		<a href="<?php echo esc_url($linkURL7); ?>" title="<?php echo __('Google Plus', 'templatemela');?> " class="google-plus icon"><i class="fa fa-google-plus"></i></a>
	<?php endif; ?>
	<?php if(!empty($linkURL8)) :  ?>
		<a href="<?php echo esc_url($linkURL8); ?>" title="<?php echo __('Skype', 'templatemela');?>" class="skype icon"><i class="fa fa-skype"></i></a>
	<?php endif; ?>
</div>
<?php
		echo $after_widget;			
