...
<div id="tab-container" class='tab-container'>
  ...
  <div class='panel-container'>
    ...
    ?>
        ...
        <div class="background-title">
          <label>
          <?php echo __('Top header Settings', 'templatemela'); ?>
          </label>
        </div>
        <?php
     foreach ($options6 as $value) { 
