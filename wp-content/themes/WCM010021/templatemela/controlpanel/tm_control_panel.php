...
<style type="text/css">
	...
	.navigation-menu{background:<?php echo tmhex2rgba(esc_attr(get_option('tmoption_top_menu_bg_color')),esc_attr(get_option('tmoption_top_menu_opacity'))); ?>}
	...
	.site-header{background:<?php echo tmhex2rgba(esc_attr(get_option('tmoption_header_bkg_color')),esc_attr(get_option('tmoption_header_bkg_opacity'))); ?>}
	.site-header {
