...
function tm_set_default_options()
{
	...
	add_option("tmoption_logo_image_alt",'Glorious'); // set logo image alt
	...
	add_option("tmoption_button_hover_color","434571"); // button hover color
	...
	add_option("tmoption_topbar_link_color","808080"); // topbar_link_color
	add_option("tmoption_topbar_link_hover_color","c3c3c3"); // topbar_link_hover_color
	add_option("tmoption_top_menu_bg_color","434571"); // Top menu background color
	...
	add_option("tmoption_top_menu_texthover_color","ff9cac"); // Top menu text hover color
	...
	add_option("tmoption_custom_text1","save upto 20% limited time only"); // Custom Text 1
	
	add_option("tmoption_custom_text2","Free Shipping on all orders"); // Custom Text 2
	
	add_option("tmoption_custom_text3","30 day money back guarantee"); // Custom Text 3	
	...
	add_option("tmoption_h1color",'434571'); // h1 family font color	 
	...
	add_option("tmoption_h2color",'434571'); // h2 family font color	
	...
	add_option("tmoption_h3color",'434571'); // h3 family font color	
	...
	add_option("tmoption_h4color",'434571'); // h4 family font color	
	...
	add_option("tmoption_h5color",'434571'); // h5 family font color	
	...
	add_option("tmoption_h6color",'434571'); // h6 family font color	
	add_option("tmoption_link_color","454545"); // link color
	add_option("tmoption_hoverlink_color","C3C3C3"); // link hovre color
	
	/*  Footer Settings  */	
	add_option("tmoption_footerbkg_color","363757"); // footer background color
	add_option("tmoption_footerlink_color","D9D9D9"); // footer link text color
...
function templatemela_load_fonts() {
	...
	wp_enqueue_style( 'raleway-user', "$protocol://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700" );
	wp_enqueue_style( 'arimo-user', "$protocol://fonts.googleapis.com/css?family=Arimo:300,400,500,600,700" );
	wp_enqueue_style( 'roboto-user', "$protocol://fonts.googleapis.com/css?family=Roboto:400,100,300,500,700" );
...
function templatemela_load_scripts() {	
	...
	wp_enqueue_script( 'jquery_scroll', get_template_directory_uri() . '/js/megnor/jquery.jscroll.js', array(), '', true);	
	wp_enqueue_script( 'jquery_scroll-min', get_template_directory_uri() . '/js/megnor/jquery.jscroll.min.js', array(), '', true);			
	?>
<!--[if lt IE 9]>
...
function tm_post_entry_date( ) {
	...
	$min = get_the_date('i');  
	$time = get_the_date('A');  
	$date = '<div class="entry-date"><i class="fa fa-calendar-o"></i><div class="day">'.$day.'/'.$month.'/'.$year.'</div> <i class="fa fa-clock-o"></i> <div class="time"> '.$hour.':'.$min.' '.$time.'</div> </div>';
	echo $date;
	return $date;
}
endif;
...
function woocommerce_output_crosssell() {
...
add_action( 'woocommerce_after_cart', 'woocommerce_output_crosssell', 10 );
...
add_action( 'woocommerce_before_shop_loop_item_title', 'yith_wcwl_add_to_wishlist_in_shop', 11 );
endif;
