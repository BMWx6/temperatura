...
{	
   extract(shortcode_atts(array(
	...
	$variables = '';
		...
		if($hover == "yes"):
			$output .='<div class="banner '.$classname.' animated " data-animated="'.$animation.'" style="'.$variables.';"><a href="'.$link_url.'" target="_blank"><img  data-animated="fadeInLeft" src="'.$image.'" alt=""/>
	   			<span class="hover_glass"></span></a></div>';	
		else :
		  $output .='<div class="banner animated '.$classname.'" data-animated="'.$animation.'" style="'.$variables.';"><a href="'.$link_url.'" target="_blank"><img  data-animated="fadeInLeft" src="'.$image.'" alt=""/>
	   			</a></div>';	
		endif;
	return $output;
}
	...
	while ( $blog_array->have_posts() ) : $blog_array->the_post();
		...
		if( empty ( $src ) || $src == 'image_not_specified' ):
			...
			$output .= '<div class="container-inner">';
				...
				$output .= '<div class="post-date"><div class="day">'.$post_day.'</div><div class="month">'.$post_month.'</div></div>';	
				$output .= '</div>';
				...
				$output .= '<div class="post-description">'.templatemela_blog_post_excerpt(20).'</div>';				
			     
			if($comments->total_comments > 0):
          		$output .='<div class="comments-link"><a href="'.get_permalink().'"><i class="fa fa-comments"></i>'.$comments->total_comments.' comment</a> </div> <div class="post_author1"><i class="blog-icon fa fa-user"></i>'.$post_author.'&nbsp;&nbsp;</div>';
       		else:
          		$output .='<div class="comments-link"><a href="'.get_permalink().'"><i class="fa fa-comments"></i>Leave a comment</a> </div> <div class="post_author1"><i class="blog-icon fa fa-user"></i>'.$post_author.'&nbsp;&nbsp;</div>';
         	endif;
			$output .= '</div></div></div>';
		$i++;
	endwhile;
		...
		if( empty ( $src ) || $src == 'image_not_specified' ):
			...
			$output .= '<div class="container-inner">';
				...
				$output .= '<div class="post-content-inner">';				
					...
					if($comments->total_comments > 0):
						$output .='<div class="comments-link"><a href="'.get_permalink().'"><i class="fa fa-comments"></i>'.$comments->total_comments.' comment</a> </div> <div class="post_author1"><i class="blog-icon fa fa-user">				
					</i>'.$post_author.'&nbsp;&nbsp;</div>';
					else:
						$output .='<div class="comments-link"><a href="'.get_permalink().'"><i class="fa fa-comments"></i>Leave a comment</a> </div> <div class="post_author1"><i class="blog-icon fa fa-user"></i>'.$post_author.'&nbsp;&nbsp;</div>';
					endif;				
...
function shortcode_parallax_image($atts, $content = null)
{
	extract(shortcode_atts(array(
		...
		$output .= '<div class="parallax-container" style="'.$variables.'">';
		$output .= '<div class="parallax-inner-container">';
		$output .= '<div class="parallax-text"> '.$parallax_text.' <span class="hightlight-text1">'.$highlight_text1.'</span> </div>';
		$output .= '<div class="hightlight-text2">'.$highlight_text2.'</div>';
		$output .= '<div class="description">'.$description.'</div>';
		$output .= '</div></div>';
		return $output;
}
...
function shortcode_parallax_child($atts, $content = null)
{
	extract(shortcode_atts(array(
		'background_color' => '',
		'background_image' => '',
		...
		$output .= '<div class="parallax-container" style="'.$variables.'">';
		$output .= '<div class="parallax-inner-container">';
		$output .= '<div class="parallax-text"><span class="hightlight-text1">'.$highlight_text1.'</span> '.$parallax_text.' <span class="hightlight-text2">'.$highlight_text2.'</span> </div>';
		$output .= '<div class="hightlight-text3">'.$highlight_text3.'</div>';
		$output .= '<div class="description">' .$description. '</div>';
		$output .= do_shortcode($content).'</div></div>';
		return $output;
}
add_shortcode('tm_parallax_child', 'shortcode_parallax_child');
